...
registerResource({
  ...
  plural: 'users',
  table: 'users',
  description: 'User = a messaging-platform identifier. Namespaced so distinct channels with numeric IDs do not collide: "phone:+1555...", "tg:123", "discord:456". A single human can own multiple user rows across channels.',
  idColumn: 'id',
  columns: [
